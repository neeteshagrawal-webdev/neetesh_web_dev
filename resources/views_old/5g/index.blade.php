...
<div class="container-fluid">
 <div class="col-md-2">
  ...
  <div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">5G</h1>
  </div>
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <div class="h5 mb-0 font-weight-bold text-gray-800"><a style="font-size: 16px;color:#4e73df;" href="{{route('5G.overview')}}" class=" font-weight-bold">
          ...
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <div class="h5 mb-0 font-weight-bold text-gray-800">
                  <a style="font-size: 16px;color:#1cc88a;" href="{{route('5G.brochure')}}" class=" font-weight-bold">
                  Click Here <i class="fas fa-arrow-right"></i>
                  </a>
              </div>
            </div>
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <div class="row no-gutters align-items-center">
                <div class="col-auto">
                <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><a style="font-size: 16px;color:#f39c12;" href="{{route('5G.advisories')}}" class=" font-weight-bold">
                Click Here <i class="fas fa-arrow-right"></i>
                </a></div>
                </div>
              </div>
        ...
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              ...
              <div class="row no-gutters align-items-center">
                <div class="col-auto">
                  <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><a style="font-size: 16px;color:#dd4b39;" href="{{route('5G.multimedia')}}" class=" font-weight-bold">
                  Click Here <i class="fas fa-arrow-right"></i>
                  </a></div>
                </div>
              </div>

...
<body>
    ...
    <div class="input-row">
        <div class="input-box underline">
            ...
            <div class="underline"></div>
            <span class="text-danger error-text email_error error" id="emailError"></span>
        </div>
        <div class="input-box underline">
            <input type="number" name="phone_number" id="phone_number" placeholder="Enter Phone Number" required>
            <div class="underline"></div>
    ...
    <div class="input-box underline">
     ...
     <div class="input-box button" style="border-radius: 5px;
    color: white;
    background: #0e2f57;
    text-align: center;
    line-height: 40px;">
           
            <a style="color:white;text-decoration:none;" class="btn btn-primary text-light" href="{{route('login')}}">Already a user ? Login here.</a>
        </div>
    </form>
    </div>
</body>
                ...
                success: function(response) {
                 // alert(response);
                    if (response.status == "success") {
                        ...
                        Signup successfully! Admin will activate your account.
                        </div>
                        `);
                ...
                error: function (xhr) {
                  if (xhr.status === 422) {
                    ...
                    if (errors.phone_number){
                        ...
                        $("#phoneError").text(errors.phone_number[0]);
                    } else{
                        $("#phoneError").text("");
                    }

...
html, body{
  ...
  width: 100%;
  place-items: center;
  background: url('assets/admin_css/img/maxresdefault.jpeg') no-repeat center center fixed;
  ...
  <body>
    <div class="container">
     <form method="POST" action="">
        ...
        <div class="title" >Login <img style="height: 50px;float: right;" src="assets/admin_css/img/logoSnT2.png" alt="KWS Logo"></div>

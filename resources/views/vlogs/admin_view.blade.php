   ...
   <i class="bi bi-arrow-left"></i> Back
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <h6 class="m-0 font-weight-bold " style="color: #29b853;">Blog</h6>
            <!-- Add Button -->
       </div>
        <div class="card-body">
                ...
                <table class="table table-bordered" id="dataTable" style="width:100%;font-size: 12px;" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <button class="btn btn-sm btn-danger" id="accept_btn_{{$data->id}}" onclick="changeStatus({{$data->id}})">Show Blog</button></br>
  ...
  <div class="modal fade" id="confirmUserModal1__id" tabindex="-1" role="dialog" aria-labelledby="deleteCategoryModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure you want to make this blog visible to users ?
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                    <button type="button" onclick="acceptUser()" class="btn btn-danger">Yes</button>
                </div>
            </div>
        </div>
    </div>
...
function acceptUser(){
        ...
        alert(blogId);
        $.ajax({
            url: '/changeblogStatus/' + blogId, // Route to delete user
            type: 'get',
            data: {
